...
copy_test_themes() {
    cp -rf ./tests/assets/themes/test-child-theme $WP_CORE_DIR/wp-content/themes/
    cp -rf ./tests/assets/themes/test-theme $WP_CORE_DIR/wp-content/themes/
}

copy_random_location_icons() {
	 cp -rf ./tests/assets/random-location-icons $WP_CORE_DIR/wp-content/
}
